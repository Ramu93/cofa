      ...
      <div class="col-md-12">
          ...
          <div class="box">
            <div class="box-header with-border">
              <h3 class="box-title pull-left">Project Status</h3>
            ...
            <!-- /.box-header -->
            <div class="box-body">
              <table class="table table-bordered" id="projectstatus_table">
                <thead>
                  <tr>
                ...
                <tbody>
                  <?php $datatableflag=false;
                   $query = "SELECT a.order_uuid, b.company_name, b.project_type, a.order_status FROM orders a, marketing_enquiry b WHERE a.enquiry_uuid=b.enquiry_uuid";
...
<script type="text/javascript">
  ...
  $(document).ready(function(){
    <?php if($datatableflag){ ?>
      $('#projectstatus_table').DataTable();
    <?php } ?>
  });
  
  function showdetails(order_uuid, endpoint){

    var data = "order_uuid="+order_uuid+"&endpoint="+endpoint+"&action=show_job_details";
    $.ajax({
